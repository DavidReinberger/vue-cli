...
const path = require('path'); console.log('2')
const debug = require('debug'); console.log('3')
const chalk = require('chalk'); console.log('4')
const readPkg = require('read-pkg'); console.log('5')
const merge = require('webpack-merge'); console.log('6')
const Config = require('webpack-chain'); console.log('7')
const PluginAPI = require('./PluginAPI'); console.log('8')
const loadEnv = require('./util/loadEnv'); console.log('8')
const defaultsDeep = require('lodash.defaultsdeep'); console.log('9')
const { warn, error, isPlugin, loadModule } = require('@vue/cli-shared-utils'); console.log('10')
